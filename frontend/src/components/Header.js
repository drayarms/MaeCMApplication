...
export default function Header() {
  ...
  // Show strip everywhere except homepage
  const showTopStrip = location.pathname !== "/";
          ...
          <nav className={`main-nav ${isOpen ? "open" : ""}`}>
            <ul className="nav-list d-flex align-items-center mb-0">
              ...
              >
                ...
                <div
                  className={`services-panel p-3 ${
                    servicesOpen ? "visible" : ""
                  }`}
                  onMouseEnter={() => setServicesOpen(true)}
                  onMouseLeave={() => setServicesOpen(false)}
                >
                    ...
                    <li className="service-item">
                      <NavLink
                        ...
                        onClick={(e) => {
                          ...
                          closeMobileMenus();
                          navigateWithTransition(
                            "/services/residential-remodel-renovations"
                          );
                        }}
                      >
                        RESIDENTIAL REMODEL / RENOVATIONS
                    ...
                    <li className="service-item">
                      <NavLink
                        ...
                        onClick={(e) => {
                          ...
                          closeMobileMenus();
                          navigateWithTransition(
                            "/services/sb721-sb362-balcony-deck-inspections"
                          );
                        }}
                      >
                        SB721/SB362 BALCONY &amp; DECK INSPECTIONS
                    ...
                    <li className="service-item">
                      <NavLink
                        ...
                        onClick={(e) => {
                          ...
                          closeMobileMenus();
                          navigateWithTransition(
                            "/services/engineering-associated-services"
                          );
                        }}
                      >
                        ENGINEERING &amp; ASSOCIATED SERVICES
